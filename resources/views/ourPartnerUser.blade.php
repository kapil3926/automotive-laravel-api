...
<div class=content>
    <div class="wrapper-1">
        <div class="wrapper-2">
            <h1>Thank you !</h1>
            <p>We are happy that you reached us. </p>
            <p>We will get back to you soon. </p>
            <p style="text-align: right">Regards,</p>
            <p style="text-align: right">MOSPL Team</p>
        </div>
        <div class="footer-like">
            <p style="text-align: center">Thank you
                <a target="_blank" href="https://theonlinechemist.co.in/metrolinkWebTest/#/">go to website</a>
            </p>
        </div>
    </div>
</div>
